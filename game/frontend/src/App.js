...
<section class="home-section section-hero overlay bg-image" style={{backgroundImage: "url('images/hero_1.jpg')"}} id="home-section">
...
<section class="py-5 bg-image overlay-primary fixed overlay" style={{backgroundImage: "url('images/hero_1.jpg')"}}>
  <div class="container">
